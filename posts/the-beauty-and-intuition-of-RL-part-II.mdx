...
<Figure src="/part2/image 9.png" alt="Efficient for TD because you can just hop to the terminal nodes in one step and obtain a good estimate of the value" caption="Efficient for TD because you can just hop to the terminal nodes in one step and obtain a good estimate of the value"/>

<Figure src="/part2/image 10.png" alt="Not efficient for TD because you’re good estimate is relying on the next state which is relying on the next and the next and the next…" caption="Not efficient for TD because you’re good estimate is relying on the next state which is relying on the next and the next and the next…"/>
...
<Figure src="/part2/image 11.png" alt="With a transition model" caption="With a transition model"/>

<Figure src="/part2/image 12.png" alt="without a transition model" caption="without a transition model"/>
...
<Figure src="/part2/image 21.png" alt="image 21.png" />
