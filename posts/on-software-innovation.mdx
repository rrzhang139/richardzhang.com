---
title: On Software Innovation
slug: on-software-innovation
description: How are the anatomic making stones of innovation settled in the software industry?
---

# On Software Innovation

<PostMeta createdAt="25 November 2022" lastUpdated="25 November 2022" />

### Abstract

This article explores the philosophical and immutable patterns in software innovation.

## Actuality of Things

<i>
  In early November of 2022, I met one of the earliest miners of Bitcoin who
...
<i>
  Some technologies fade simply because they cannot handle growth or stability.
  Some fade because we greedy humans mostly blame technologies without
  sufficiently observing the context.
</i>
...
So, first, let's think for a minute. What is innovation? Make sure to think about yourself first, but my answer is below.
...
<i>
  I hope we uphold all the chaos we humans created for each other in the past.
  Yet, we also proved our ability for good, didn't we? Do we happen to
  neutralize our faults enough to become self-sustainable?
</i>

### AI From the Future?

Do I agree that Satoshi was an AI from the future? There is no way I believe that. The proposal and initial design of Bitcoin can be made by a small group (or possibly someone) of very high intellect that has put in the extreme work required. Still, after some thought, it is possible to see why this person I met thinks about some post-human interference.
